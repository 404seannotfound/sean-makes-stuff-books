...
GENRE = "Audiobook"
YEAR = "2026"
COMMENT = "A short illustrated cooking tutorial — Mara and Theo cook the perfect New York strip with the Maillard crust."
...
# Restore CHAP + CTOC from scriptorium source (re-encode dropped them)
